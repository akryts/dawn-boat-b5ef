...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dawn-boat-b5ef
```

A live public deployment of this template is available at [https://dawn-boat-b5ef.templates.workers.dev](https://dawn-boat-b5ef.templates.workers.dev)
